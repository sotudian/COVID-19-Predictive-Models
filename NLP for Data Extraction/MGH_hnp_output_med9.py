...
for filename in files:
    ...
    out_line = ['Prior to Admission Medications in hnp(9', filename, Time]
    out_line2 = ['COVID19 Medications in hnp(9', filename, Time]
    out_line3 = ['Past Medical History inferred by med(9', filename, Time]
    out_line.extend(D)
