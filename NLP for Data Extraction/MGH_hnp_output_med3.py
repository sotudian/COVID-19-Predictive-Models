...
for filename in files:
    ...
    for (i, line) in enumerate(lines):
        if started == 0:
            ...
            if line[0].find('Facility-Administered Medications') != - \
                    1 or line[0].find('Facility-Administered Medications'.upper()) != -1:
                started = 1
                n += 1
    ...
    out_line = ['Prior to Admission Medications in hnp(3', filename, Time]
    out_line2 = ['COVID19 Medications in hnp(3', filename, Time]
    out_line3 = ['Past Medical History inferred by med(3', filename, Time]
    out_line.extend(D)
